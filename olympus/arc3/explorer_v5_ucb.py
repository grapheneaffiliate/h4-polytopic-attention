"""
ARC-AGI-3 Explorer v5 — UCB1 action selection.

All v4 features PLUS:
1. Per-state UCB1: (state, action) → reward tracking, adaptive C
2. Dead action pruning: 0 reward after 10+ visits → score -1
3. Stall detection: 10+ episodes with 0 new states → force mode switch
"""
...
def solve_game(arc, game_id, max_actions=200000, verbose=True):
    ...
    agent = UnifiedAgentV5(grid_step=4)
